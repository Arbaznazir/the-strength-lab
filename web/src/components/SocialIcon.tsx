...
import type { ShareTarget, SocialPlatform } from "@/lib/site";
...
function TumblrIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden fill="currentColor">
      <path d="M14.563 24c-5.093 0-7.031-3.776-7.031-6.411V9.747H5.116V6.648c3.63-1.313 4.512-4.596 4.71-6.469C9.84.051 9.941 0 9.999 0h3.517v6.114h4.801v3.633H13.58v7.313c0 1.703 1.047 2.625 2.922 2.625 1.004 0 1.901-.091 2.72-.263v3.794c-.615.291-1.815.591-3.659.591z" />
    </svg>
  );
}
...
const SHARE_ICONS: Record<ShareTarget, ComponentType<IconProps>> = {
  twitter: TwitterIcon,
  facebook: FacebookIcon,
  linkedin: LinkedinIcon,
  reddit: RedditIcon,
...
export function ShareTargetIcon({
  target,
  className,
}: {
  target: ShareTarget;
  ...
  return <Icon className={clsx("h-5 w-5", className)} />;
}
